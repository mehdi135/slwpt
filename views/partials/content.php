    ...
    <div class="content-wrap">
        ...
        <div class="container clearfix">
                ...
                <div class="fslider" data-arrows="false">
                    <div class="flexslider">
                        <div class="slider-wrap">
                            <div class="slide">
                                <a href="#">
                                    <img src="<?php Asset::images('shop/slider/1.jpg') ?>" alt="Shop Image">
                                </a>
                            </div>
                            <div class="slide">
                                <a href="#">
                                    <img src="<?php echo Asset::images('shop/slider/2.jpg') ?>" alt="Shop Image">
                                </a>
                            </div>
                            <div class="slide">
                                <a href="#">
                                    <img src="<?php echo Asset::images('shop/slider/3.jpg') ?>" alt="Shop Image">
                                </a>
                            </div>
                            <div class="slide">
                                <a href="#">
                                    <img src="<?php echo Asset::images('shop/slider/4.jpg') ?>" alt="Shop Image">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col_one_third bottommargin-lg col_last">
                ...
                <div class="col_full bottommargin-sm">
                    <a href="#"><img src="<?php echo Asset::images('shop/banners/7.jpg') ?>" alt="Image"></a>
                </div>

                <div class="col_full nobottommargin">
                    <a href="#"><img src="<?php echo Asset::images('shop/banners/3.jpg') ?>" alt="Image"></a>
                </div>
        ...
        <div class="container clearfix">
            ...
            <div class="col_one_third bottommargin-lg">
                <div class="feature-box center media-box fbox-bg">
                    <div class="fbox-media">
                        <img src="<?php echo Asset::images('shop/banners/10.jpg') ?>" alt="Image">
                    </div>
                    <div class="fbox-desc">
            ...
            <div class="col_one_third bottommargin-lg">
                <div class="feature-box center media-box fbox-bg">
                    <div class="fbox-media">
                        <img src="<?php echo Asset::images('shop/banners/11.jpg') ?>" alt="Image">
                    </div>
                    <div class="fbox-desc">
            ...
            <div class="col_one_third bottommargin-lg col_last">
                <div class="feature-box center media-box fbox-bg">
                    <div class="fbox-media">
                        <img src="<?php echo Asset::images('shop/banners/12.jpg') ?>" alt="Image">
                    </div>
                    <div class="fbox-desc">
                        ...
                        <?php while ($new_products->have_posts()): $new_products->the_post(); ?>
                            <div class="spost clearfix">
                                <div class="entry-image">
                                    <a href="<?php echo get_the_permalink();?>"><img src="<?php echo Asset::images('shop/small/1.jpg'); ?>" alt="Image"></a>
                                </div>
                                <div class="entry-c">
            ...
            <div class="col_one_third nobottommargin">
                ...
                <div>
                    ...
                    <div class="spost clearfix">
                        <div class="entry-image">
                            <a href="#"><img src="<?php echo Asset::images('shop/small/3.jpg'); ?>" alt="Image"></a>
                        </div>
                        <div class="entry-c">
                            <div class="entry-title">
                    ...
                    <div class="spost clearfix">
                        <div class="entry-image">
                            <a href="#"><img src="<?php echo Asset::images('shop/small/10.jpg'); ?>" alt="Image"></a>
                        </div>
                        <div class="entry-c">
                            <div class="entry-title">
                    ...
                    <div class="spost clearfix">
                        <div class="entry-image">
                            <a href="#"><img src="<?php echo Asset::images('shop/small/11.jpg'); ?>" alt="Image"></a>
                        </div>
                        <div class="entry-c">
                            <div class="entry-title">
                    ...
                    <div class="spost clearfix">
                        <div class="entry-image">
                            <a href="#"><img src="<?php echo Asset::images('shop/small/4.jpg'); ?>" alt="Image"></a>
                        </div>
                        <div class="entry-c">
                            <div class="entry-title">
            ...
            <div class="col_one_third nobottommargin col_last">
                ...
                <div>
                    ...
                    <div class="spost clearfix">
                        <div class="entry-image">
                            <a href="#"><img src="<?php echo Asset::images('shop/small/8.jpg'); ?>" alt="Image"></a>
                        </div>
                        <div class="entry-c">
                            <div class="entry-title">
                    ...
                    <div class="spost clearfix">
                        <div class="entry-image">
                            <a href="#"><img src="<?php echo Asset::images('shop/small/5.jpg'); ?>" alt="Image"></a>
                        </div>
                        <div class="entry-c">
                            <div class="entry-title">
                                <h4><a href="#">Blue Round-Neck Tshirt</a></h4>
                    ...
                    <div class="spost clearfix">
                        <div class="entry-image">
                            <a href="#"><img src="<?php echo Asset::images('shop/small/12.jpg'); ?>" alt="Image"></a>
                        </div>
                        <div class="entry-c">
                            <div class="entry-title">
                    ...
                    <div class="spost clearfix">
                        <div class="entry-image">
                            <a href="#"><img src="<?php echo Asset::images('shop/small/2.jpg'); ?>" alt="Image"></a>
                        </div>
                        <div class="entry-c">
                            <div class="entry-title">
